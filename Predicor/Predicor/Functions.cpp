...
float BestAverage5 = 0, BestAverage12 = 0, BestAverage50 = 0, BestAverage100 = 0;
float CurrentAverage5 = 0, CurrentAverage12 = 0, CurrentAverage50 = 0, CurrentAverage100 = 0;
string solve = " ";
...
void InputAverages() {
    ...
    cin >> solve;
    if (solve == "DNF") BestAverage5 = 99999;
    else BestAverage5 = atof(solve.c_str());
 
    cout << "Введите среднее по AVG 12: ";
    cin >> solve;
    if (solve == "DNF") BestAverage12 = 99999;
    else BestAverage12 = atof(solve.c_str());

    cout << "Введите среднее по AVG 50: ";
    cin >> solve;
    if (solve == "DNF") BestAverage50 = 99999;
    else BestAverage50 = atof(solve.c_str());

    cout << "Введите среднее по AVG 100: ";
    cin >> solve;
    if (solve == "DNF") BestAverage100 = 99999;
    else BestAverage100 = atof(solve.c_str());
}
...
void Input() {
    while (true) {
        ...
        if (solve == "DNF") Solves[NumberSolve] = 99999;
        else Solves[NumberSolve] = atof(solve.c_str());
        ...
        if (NumberSolve > 4) {
            if ((sum5() - maximum5() - minimum5()) / 3 < BestAverage5) {
                BestAverage5 = (sum5() - maximum5() - minimum5()) / 3;
            }
        }
        ...
        if (NumberSolve > 11) {
            if ((sum12() - maximum12() - minimum12()) / 10 < BestAverage12) {
                BestAverage12 = (sum12() - maximum12() - minimum12()) / 10;
            }
        }
        ...
        if (NumberSolve > 49) {
            maximum50();
            minimum50();
            if ((sum50() - FirstMaximum50 - SecondMaximum50 - ThirdMaximum50 - FirstMinimum50 - SecondMinimum50 - ThirdMinimum50) / 44 < BestAverage50) {
                BestAverage50 = (sum50() - FirstMaximum50 - SecondMaximum50 - ThirdMaximum50 - FirstMinimum50 - SecondMinimum50 - ThirdMinimum50) / 44;
            }
        }
        ...
        if (NumberSolve > 99) {
            maximum100();
            minimum100();
            if ((sum100() - FirstMaximum100 - SecondMaximum100 - ThirdMaximum100 - FourthMaximum100 - FivthMaximum100 - FirstMinimum100 - SecondMinimum100 - ThirdMinimum100 - FourthMinimum100 - FivthMinimum100) / 90 < BestAverage100) {
                BestAverage100 = (sum100() - FirstMaximum100 - SecondMaximum100 - ThirdMaximum100 - FourthMaximum100 - FivthMinimum100 - FirstMinimum100 - SecondMinimum100 - ThirdMinimum100 - FourthMinimum100 - FivthMinimum100) / 90;
            }
        }
        NumberSolve++;
    }
...
/* В функции "Output5" осуществляется предсказание веса пятой сборки.
   */
void Output5() {
    float FinalSolve = 3 * BestAverage5 - sum4() + minimum4() + maximum4();
    if (sum4() - minimum4() < 3 * BestAverage5) cout << "Вы в любом случае обновите PB по AVG 5." << endl;
    else if (sum4() - maximum4() >= 3 * BestAverage5) cout << "Вы не обновите PB по AVG 5." << endl;
    else cout << "Чтобы обновить PB по AVG 5, нужно собрать быстрее " << FinalSolve << " секунд." << endl;
    cout << "Текущее AVG 5: " << CurrentAverage5;
}
...
/* В функции "Output12" осуществляется предсказание веса двеннадцатой сборки.
   */
void Output12() {
    float FinalSolve = 10 * BestAverage12 - sum11() + minimum11() + maximum11();
    if (sum11() - minimum11() < 10 * BestAverage12) cout << "Вы в любом случае обновите PB по AVG 12." << endl;
    else if (sum11() - maximum11() >= 10 * BestAverage12) cout << "Вы не обновите PB по AVG 12." << endl;
...
void Output50() {
    minimum49();
    maximum49();
    float FinalSolve = 44 * BestAverage50 - sum49() + FirstMaximum49 + SecondMaximum49 + ThirdMaximum49 + FirstMinimum49 + SecondMinimum49 + ThirdMinimum49;
    if (sum49() - FirstMaximum49 - SecondMaximum49 - FirstMinimum49 - SecondMinimum49 - ThirdMinimum49 < 44 * BestAverage50) cout << "Вы в любом случае обновите PB по AVG 50." << endl;
    else if (sum49() - FirstMaximum49 - SecondMaximum49 - ThirdMaximum49 - FirstMinimum49 - SecondMinimum49 >= 44 * BestAverage50) cout << "Вы не обновите PB по AVG 50." << endl;
...
void Output100() {
    maximum99();
    minimum99();
    float FinalSolve = 90 * BestAverage100 - sum99() + FirstMinimum99 + SecondMinimum99 + ThirdMinimum99 + FourthMinimum99 + FivthMinimum99 + FirstMaximum99 + SecondMaximum99 + ThirdMaximum99 + FourthMaximum99 + FivthMaximum99;
    if (sum99() - FirstMaximum99 - SecondMaximum99 - ThirdMaximum99 - FourthMaximum99 - FirstMinimum99 - SecondMinimum99 - ThirdMinimum99 - FourthMinimum99 - FivthMinimum99 < 90 * BestAverage100) cout << "Вы в любом случае обновите PB по AVG 100." << endl;
    else if (sum99() - FirstMaximum99 - SecondMaximum99 - ThirdMaximum99 - FourthMaximum99 - FivthMaximum99 - FirstMinimum99 - SecondMinimum99 - ThirdMinimum99 - FourthMinimum99 >= 90 * BestAverage100) cout << "Вы не обновите PB по AVG 100." << endl;
